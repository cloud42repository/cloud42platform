# zoho-people.service.spec.ts

Unit test for the `ZohoPeopleService` class, verifying that the service can be instantiated via the NestJS testing module and that its default HTTP client is properly initialized.

## Test Suites

- **ZohoPeopleService** — Validates service instantiation and client initialization.
