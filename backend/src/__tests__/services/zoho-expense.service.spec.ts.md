# zoho-expense.service.spec.ts

Unit test for the `ZohoExpenseService` class, verifying that the service can be instantiated via the NestJS testing module and that its default HTTP client is properly initialized.

## Test Suites

- **ZohoExpenseService** — Validates service instantiation and client initialization.
