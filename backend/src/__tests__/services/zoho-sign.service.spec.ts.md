# zoho-sign.service.spec.ts

Unit test for the `ZohoSignService` class, verifying that the service can be instantiated via the NestJS testing module and that its default HTTP client is properly initialized.

## Test Suites

- **ZohoSignService** — Validates service instantiation and client initialization.
