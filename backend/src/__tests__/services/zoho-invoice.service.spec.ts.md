# zoho-invoice.service.spec.ts

Unit test for the `ZohoInvoiceService` class, verifying that the service can be instantiated via the NestJS testing module and that its default HTTP client is properly initialized.

## Test Suites

- **ZohoInvoiceService** — Validates service instantiation and client initialization.
