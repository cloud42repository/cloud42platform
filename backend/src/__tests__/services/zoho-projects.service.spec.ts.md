# zoho-projects.service.spec.ts

Unit test for the `ZohoProjectsService` class, verifying that the service can be instantiated via the NestJS testing module and that its default HTTP client is properly initialized.

## Test Suites

- **ZohoProjectsService** — Validates service instantiation and client initialization.
