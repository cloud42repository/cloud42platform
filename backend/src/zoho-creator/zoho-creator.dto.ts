...
export type CreatorFormType = "form" | "section";

export interface CreatorForm {
  link_name?: string;
  form_name?: string;
  type?: CreatorFormType;
  fields?: CreatorField[];
  created_time?: string;
}
...
export type CreatorFieldType = "Text" | "Number" | "Email" | "Phone" | "Date" | "DateTime" | "Dropdown" | "MultiSelect" | "Checkbox" | "Radio" | "File" | "Image" | "Subform";
...
export interface CreatorListParams extends ZohoListParams {
  criteria?: string;
  sort_by?: string;
  sort_order?: "asc" | "desc";
}
